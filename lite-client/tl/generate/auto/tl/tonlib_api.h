...
class key final : public Object {
 public:
  ...
  static const std::int32_t ID = -974921350;
  std::int32_t get_id() const final {
    return ID;
  }
...
class createNewKey final : public Function {
 public:
  ...
  createNewKey(td::SecureString &&local_password_, td::SecureString &&mnemonic_password_);

  static const std::int32_t ID = -57453510;
  std::int32_t get_id() const final {
    return ID;
  }
